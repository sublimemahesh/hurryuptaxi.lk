...
<html> 
    <head>
        ...
        <title>Edit Vehicle Type || www.hurryuptaxi.lk</title>
        <!-- Favicon-->
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="name" class="form-control" value="<?php echo $VEHICLE_TYPE->name; ?>" required="TRUE" placeholder=" Vehicle Name" autocomplete="off" name="name" >
                                        </div>
                                    </div>
                                </div>
                            </div> 
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <img  src="<?php echo $VEHICLE_TYPE->image ?>"  name="image">
                                        </div>
                                    </div>
                                </div>
                            </div>
