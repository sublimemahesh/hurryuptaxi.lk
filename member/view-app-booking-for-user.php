...
<html>
    ...
    <head>
        ...
        <title>View App Booking for user || Admin || hurryuptaxi.lk</title>
        <!-- Favicon-->
                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    <table id="myTable"class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach ($DRIVER->GetDriversByUser($USER->id) as $key => $driver) {
                                                foreach ($APPBOOKING->getBookingsByDriver($driver['id']) as $app_booking) {
                                                    $key++;
                                                    ?>
