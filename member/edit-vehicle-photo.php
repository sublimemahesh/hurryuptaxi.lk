...
$vehiclePhoto = new VehiclePhotos($id);
?> 
...
<html> 
    <head>
        ...
        <title>Edit Vehicle Photo : <?php echo $vehiclePhoto->caption; ?></title>
        <!-- Favicon-->
                        ...
                        <div class="card">
                            <div class="header">
                                ...
                                <ul class="header-dropdown">
                                    <li class="">
                                        <a href="add-vehicle-photos.php?id=<?php echo $vehiclePhoto->driver; ?>">
                                ...
                                <form class="form-horizontal" method="post" action="post-and-get/vehicle-photos.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                            <input type="hidden" id="oldImageName" value="<?php echo $vehiclePhoto->image_name; ?>" name="oldImageName"/>
                                            <input type="hidden" id="id" value="<?php echo $vehiclePhoto->id; ?>" name="id"/>
