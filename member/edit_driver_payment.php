                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text"   class="form-control"   autocomplete="off" value="<?php
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="number" id="price" class="form-control"  name="price" value="<?php echo $DRIVER_PAYMENT->price; ?>" required="TRUE" placeholder="Price" min="0">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <select class="form-control" name="status">
                                                <option value="<?php echo $DRIVER_PAYMENT->status; ?>"><?php echo $DRIVER_PAYMENT->status; ?></option>
