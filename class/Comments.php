...
class Comments {
    ...
    public function __construct($id) {
        if ($id) {
            ...
            $query = "SELECT `id`,`name`,`city`,`image_name`,`comment`,`is_active`,`queue` FROM `comments` WHERE `id`=" . $id;
    ...
    public function create() {
        ...
        $query = "INSERT INTO `comments` (`name`,`city`,`image_name`,`comment`,`is_active`,`queue`) VALUES  ('"
                . $this->name . "','"
                . $this->city . "','"
                . $this->image_name . "', '"
                . $this->comment . "', '"
