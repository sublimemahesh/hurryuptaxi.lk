...
$document.ready(function () {
	...
	if (plugins.bookingForm.length) {
		...
		$('#setDateBtn').on('click', function () {
			var calendarUp = $("#calendarUp").datepicker('getDate'),
				calendarDown = $("#calendarDown").datepicker('getDate'),
				time = $("#selectPrevTime option:selected").val(),
				timeNext = $("#selectNextTime option:selected").val(),
				location = $("#selectPrevLocation option:selected").val(),
				location2 = $("#selectPrevLocation2 option:selected").val();
			$('#datetimepicker1').data("DateTimePicker").date(calendarUp);
			$('#datetimepicker2').data("DateTimePicker").date(calendarDown);
			$('#timepicker1').data("DateTimePicker").date(time);
			$('#timepicker2').data("DateTimePicker").date(timeNext);
			$('#location1').val(location);
			$('#location2').val(location2);
		})
		$('#setDateBtn2').on('click', function () {
			var calendarUpMob = $("#calendarUpMob").datepicker('getDate'),
				calendarDownMob = $("#calendarDownMob").datepicker('getDate'),
				timeMob = $("#selectPrevTimeMob option:selected").val(),
				timeNextMob = $("#selectNextTimeMob option:selected").val(),
				locationMob = $("#selectPrevLocationMob option:selected").val(),
				location2Mob = $("#selectPrevLocation2Mob option:selected").val();
			$('#datetimepicker1').data("DateTimePicker").date(calendarUpMob);
			$('#datetimepicker2').data("DateTimePicker").date(calendarDownMob);
			$('#timepicker1').data("DateTimePicker").date(timeMob);
			$('#timepicker2').data("DateTimePicker").date(timeNextMob);
			$('#location1').val(locationMob);
			$('#location2').val(location2Mob);
		})
