	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			var top_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='prev action-prev' style='margin-left: 10px;'></div>" :
				"<div class='prev action-next' style='margin-left: 10px;'></div>";
			var bottom_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='next action-next' style='margin-left: 10px;'></div>" :
				"<div class='next action-prev' style='margin-left: 10px;'></div>";

			var new_ele = $(
				"<div class='timepicker_wrap " + settings.custom_classes + "'>" +
					"<div class='time'>" +
						top_arrow_button +
						"<div class='ti_tx'><input type='text' class='timepicki-input' style='margin-bottom:0px; border-radius: 5px;'" + (settings.disable_keyboard_mobile ? "readonly" : "") + "></div>" +
						bottom_arrow_button +
					"</div>" +
					"<div class='mins'>" +
						top_arrow_button +
						"<div class='mi_tx'><input type='text' class='timepicki-input' style='margin-bottom:0px; border-radius: 5px;'" + (settings.disable_keyboard_mobile ? "readonly" : "") + "></div>" +
						bottom_arrow_button +
					"</div>");
			if(settings.show_meridian){
				new_ele.append(
					"<div class='meridian'>" +
						top_arrow_button +
						"<div class='mer_tx'><input type='text' class='timepicki-input' style='margin-bottom:0px; border-radius: 5px;' readonly></div>" +
						bottom_arrow_button +
					"</div>");
			}
			if(settings.reset){
