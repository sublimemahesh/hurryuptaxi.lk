            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                    ...
                    <ul class="footer-list">
                        ...
                        <li><a href="rent-a-car.php">Rent A Car</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-6">
                    <div class="copyright"><span class="copyright-year">&copy; 2018</span> <a href="#" class="privacy_policy">Privacy Policy</a> <a href="#">Rental policy</a></div>
                </div>
                <div class="col-xs-12 col-md-6">
